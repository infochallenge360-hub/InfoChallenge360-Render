...
export const RemotionRoot = () => {
  return (
    <>
      ...
      <Composition id="ThumbE56CatBreed" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "catbreeds-e56-thumb", grid: ["persian", "siamese", "maine-coon", "sphynx", "?", "scottish-fold", "ragdoll", "bengal", "russian-blue"], line1: "CAN YOU NAME ALL", word: "CAT BREED?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE56CatBreedHero" component={GsThumbHeroV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "catbreeds-e56-thumb", heroSlug: "sphynx", line1: "GUESS THE", word: "CAT BREED?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE56CatBreedSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "catbreeds-e56-thumb", easySlug: "persian", hardSlug: "german-rex", word: "CAT BREED?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE56CatBreedNumber" component={GsThumbNumberV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "catbreeds-e56-thumb", cascade: ["persian", "siamese", "maine-coon", "?"], line1: "CAN YOU NAME ALL", word: "CAT BREED?", number: "70", badge: "Only 1% get 100%" }} />
