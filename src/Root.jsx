...
import { AIRPLANES_E76 } from "./Quiz/airplanesE76Data";
import { AIRPLANES_E76_FACTS } from "./Quiz/airplanesE76Facts";
...
import { NFL_E79 } from "./Quiz/nflE79Data";
...
import { ROADSIGNS_E82 } from "./Quiz/roadsignsE82Data";
...
import { WEATHER_E85 } from "./Quiz/weatherE85Data";
...
import { LANGUAGES_E90 } from "./Quiz/languagesE90Data";
...
import { EMPIRES_E96 } from "./Quiz/empiresE96Data";
...
import { COFFEE_TEA_E100 } from "./Quiz/coffeeTeaE100Data";
import { COFFEE_TEA_E100_FACTS } from "./Quiz/coffeeTeaE100Facts";
...
const E100_INFOCFG = { items: COFFEE_TEA_E100, facts: COFFEE_TEA_E100_FACTS, topicWord: "COFFEE OR TEA DRINK", topicPlural: "COFFEE & TEA DRINKS", dir: "coffeetea100", ext: "jpg", fit: "contain", voPrefix: "te-", nameField: "name", introVo: "vo-intro-coffeetea", coldSlug: "espresso" };
...
export const RemotionRoot = () => {
  return (
    <>
      ...
      <Composition id="E76AirplaneQuiz" component={QuizV2} durationInFrames={quizFrames(E76_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E76_INFOCFG }} />
      <Composition id="ThumbE76Plane" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "plane-e76-thumb", grid: ["boeing-747", "concorde", "sr-71-blackbird", "?", "f-22-raptor", "supermarine-spitfire", "wright-flyer", "p-51-mustang", "f-16-fighting-falcon"], line1: "CAN YOU NAME ALL", word: "AIRPLANES?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE76PlaneHero" component={GsThumbHeroV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "plane-e76-thumb", heroSlug: "sr-71-blackbird", line1: "GUESS THE", word: "AIRPLANE?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE76PlaneSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "plane-e76-thumb", easySlug: "boeing-747", hardSlug: "vought-v173", word: "AIRPLANE?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE76PlaneNumber" component={GsThumbNumberV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "plane-e76-thumb", cascade: ["sr-71-blackbird", "boeing-747", "concorde", "?"], line1: "CAN YOU NAME ALL", word: "AIRPLANES?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="E77StateQuiz" component={QuizV2} durationInFrames={quizFrames(E77_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E77_INFOCFG }} />
      <Composition id="ThumbE77State" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "state-e77-thumb", grid: ["tx", "fl", "ca", "?", "mi", "hi", "ak", "la", "ny"], line1: "CAN YOU NAME ALL", word: "US STATES?", number: "50", badge: "Only 1% get 100%" }} />
      ...
      <Composition id="E79NflQuiz" component={QuizV2} durationInFrames={quizFrames(E79_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E79_INFOCFG }} />
      <Composition id="ThumbE79Nfl" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "nfl-e79-thumb", grid: ["dallas-cowboys", "green-bay-packers", "pittsburgh-steelers", "?", "san-francisco-49ers", "new-england-patriots", "miami-dolphins", "philadelphia-eagles", "las-vegas-raiders"], line1: "CAN YOU NAME ALL", word: "NFL TEAMS?", number: "32", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE79NflHero" component={GsThumbHeroV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "nfl-e79-thumb", heroSlug: "dallas-cowboys", line1: "GUESS THE", word: "NFL TEAM?", number: "32", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE79NflSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "nfl-e79-thumb", easySlug: "dallas-cowboys", hardSlug: "cleveland-browns", word: "NFL TEAM?", number: "32", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE79NflNumber" component={GsThumbNumberV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "nfl-e79-thumb", cascade: ["dallas-cowboys", "green-bay-packers", "pittsburgh-steelers", "?"], line1: "CAN YOU NAME ALL", word: "NFL TEAMS?", number: "32", badge: "Only 1% get 100%" }} />
      <Composition id="E80MlbQuiz" component={QuizV2} durationInFrames={quizFrames(E80_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E80_INFOCFG }} />
      <Composition id="ThumbE80Mlb" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "mlb-e80-thumb", grid: ["new-york-yankees", "los-angeles-dodgers", "boston-red-sox", "?", "chicago-cubs", "san-francisco-giants", "st-louis-cardinals", "atlanta-braves", "new-york-mets"], line1: "CAN YOU NAME ALL", word: "MLB TEAMS?", number: "30", badge: "Only 1% get 100%" }} />
      ...
      <Composition id="E82RoadSignQuiz" component={QuizV2} durationInFrames={quizFrames(E82_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E82_INFOCFG }} />
      <Composition id="ThumbE82RoadSign" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "roadsigns-e82-thumb", grid: ["stop", "yield", "no-entry", "?", "pedestrian-crossing", "roundabout", "railroad-crossing", "hospital", "no-parking"], line1: "CAN YOU NAME ALL", word: "ROAD SIGNS?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE82RoadSignHero" component={GsThumbHeroV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "roadsigns-e82-thumb", heroSlug: "stop", line1: "GUESS THE", word: "ROAD SIGN?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE82RoadSignSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "roadsigns-e82-thumb", easySlug: "stop", hardSlug: "kangaroo-crossing", word: "ROAD SIGN?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE82RoadSignNumber" component={GsThumbNumberV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "roadsigns-e82-thumb", cascade: ["stop", "yield", "no-entry", "?"], line1: "CAN YOU NAME ALL", word: "ROAD SIGNS?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="E83MythicalQuiz" component={QuizV2} durationInFrames={quizFrames(E83_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E83_INFOCFG }} />
      ...
      <Composition id="E85WeatherQuiz" component={QuizV2} durationInFrames={quizFrames(E85_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E85_INFOCFG }} />
      <Composition id="ThumbE85Weather" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "weather-e85-thumb", grid: ["sun", "rain", "snow", "?", "thunderstorm", "rainbow", "tornado", "hurricane", "lightning"], line1: "CAN YOU NAME ALL", word: "WEATHER SYMBOLS?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE85WeatherHero" component={GsThumbHeroV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "weather-e85-thumb", heroSlug: "tornado", line1: "GUESS THE", word: "WEATHER SYMBOL?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE85WeatherSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "weather-e85-thumb", easySlug: "sun", hardSlug: "sprite", word: "WEATHER SYMBOL?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="E86ConstellationQuiz" component={QuizV2} durationInFrames={quizFrames(E86_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E86_INFOCFG }} />
      ...
      <Composition id="E88YearQuiz" component={QuizV2} durationInFrames={quizFrames(E88_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E88_INFOCFG }} />
      ...
      <Composition id="E90LanguageQuiz" component={QuizV2} durationInFrames={quizFrames(E90_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E90_INFOCFG }} />
      <Composition id="ThumbE90Language" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "language-e90-thumb", grid: ["mandarin-chinese", "japanese", "korean-hangul", "russian-cyrillic", "?", "arabic", "hebrew", "greek", "hindi-devanagari"], line1: "CAN YOU NAME ALL", word: "LANGUAGES?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE90LanguageHero" component={GsThumbHeroV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "language-e90-thumb", heroSlug: "arabic", line1: "GUESS THE", word: "LANGUAGE?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="ThumbE90LanguageSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "language-e90-thumb", easySlug: "mandarin-chinese", hardSlug: "linear-b", word: "LANGUAGE?", number: "70", badge: "Only 1% get 100%" }} />
      <Composition id="E91ReligionQuiz" component={QuizV2} durationInFrames={quizFrames(E91_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E91_INFOCFG }} />
      ...
      <Composition id="E94BodyPartQuiz" component={QuizV2} durationInFrames={quizFrames(E94_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E94_INFOCFG }} />
      ...
      <Composition id="E96EmpireQuiz" component={QuizV2} durationInFrames={quizFrames(E96_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E96_INFOCFG }} />
      {/* First episode using the v5 thumbnail template set (Mosaic/Mirror/FullBleed/Coin/Strip) — replaces the old Grid/Hero/Split set for E96 onward, per owner request 2026-09-03. */}
      <Composition id="ThumbE96EmpireMosaic" component={GsThumbMosaicV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "empire-e96-thumb", topicPlural: "EMPIRES", number: "70", grid: ["roman-empire", "british-empire", "ottoman-empire", "mongol-empire", "ancient-egypt", "mughal-empire", "russian-empire", "japanese-empire", "spanish-empire", "macedonian-empire", "qing-dynasty", "aztec-empire", "byzantine-empire", "inca-empire", "mali-empire"] }} />
      <Composition id="ThumbE96EmpireMirror" component={GsThumbMirrorV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "empire-e96-thumb", topicPlural: "EMPIRES", number: "70", grid: ["napoleonic-france", "portuguese-empire", "dutch-empire", "german-empire", "assyrian-empire", "babylonian-empire", "achaemenid-persian-empire", "holy-roman-empire", "umayyad-caliphate", "han-dynasty", "gupta-empire", "safavid-empire", "austro-hungarian-empire", "timurid-empire", "sassanid-empire"] }} />
      <Composition id="ThumbE96EmpireFullBleed" component={GsThumbFullBleedV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "empire-e96-thumb", number: "70", grid: ["roman-empire", "british-empire", "ottoman-empire", "mongol-empire", "mughal-empire", "russian-empire", "japanese-empire", "spanish-empire", "byzantine-empire", "aztec-empire", "inca-empire", "mali-empire", "khmer-empire", "songhai-empire", "maratha-empire", "visigothic-kingdom", "ptolemaic-egypt", "seljuk-empire", "ghaznavid-empire", "chola-empire", "vijayanagara-empire", "kanem-bornu-empire", "xiongnu-confederation", "sokoto-caliphate"] }} />
      <Composition id="ThumbE96EmpireCoin" component={GsThumbCoinV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "empire-e96-thumb", topicPlural: "EMPIRES", number: "70", grid: ["roman-empire", "british-empire", "ottoman-empire", "mongol-empire", "mughal-empire", "russian-empire", "aztec-empire", "inca-empire", "byzantine-empire", "ancient-egypt", "mali-empire", "macedonian-empire"] }} />
      <Composition id="ThumbE96EmpireStrip" component={GsThumbStripV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "empire-e96-thumb", topicPlural: "EMPIRES", number: "70", grid: ["roman-empire", "british-empire", "ottoman-empire", "mongol-empire", "mughal-empire", "russian-empire", "aztec-empire", "byzantine-empire", "ancient-egypt", "japanese-empire"] }} />
      <Composition id="E97HorseBreedQuiz" component={QuizV2} durationInFrames={quizFrames(E97_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E97_INFOCFG }} />
      <Composition id="ThumbE97HorseBreedMosaic" component={GsThumbMosaicV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "horsebreed-e97-thumb", topicPlural: "HORSE BREEDS", number: "70", grid: ["arabian-horse", "thoroughbred", "clydesdale", "shetland-pony", "mustang", "appaloosa", "friesian-horse", "percheron", "andalusian-horse", "shire-horse", "quarter-horse", "icelandic-horse", "welsh-pony", "paint-horse", "haflinger"] }} />
      <Composition id="ThumbE97HorseBreedMirror" component={GsThumbMirrorV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "horsebreed-e97-thumb", topicPlural: "HORSE BREEDS", number: "70", grid: ["lipizzaner", "miniature-horse", "belgian-draft", "hanoverian", "akhal-teke", "morgan-horse", "tennessee-walking-horse", "gypsy-vanner", "fjord-horse", "standardbred", "falabella", "suffolk-punch", "cleveland-bay", "trakehner", "holsteiner"] }} />
      ...
      <Composition id="E100CoffeeTeaQuiz" component={QuizV2} durationInFrames={quizFrames(E100_INFOCFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E100_INFOCFG }} />
      <Composition id="ThumbE100CoffeeTeaMosaic" component={GsThumbMosaicV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "coffeetea-e100-thumb", topicPlural: "COFFEE & TEA DRINKS", number: "70", grid: ["espresso", "cappuccino", "caffe-latte", "americano", "iced-coffee", "caffe-mocha", "frappuccino", "espresso-macchiato", "cold-brew-coffee", "black-tea", "green-tea", "iced-tea", "bubble-tea", "matcha-latte", "chamomile-tea"] }} />
      <Composition id="ThumbE100CoffeeTeaMirror" component={GsThumbMirrorV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "coffeetea-e100-thumb", topicPlural: "COFFEE & TEA DRINKS", number: "70", grid: ["earl-grey-tea", "thai-iced-tea", "kombucha", "cortado", "flat-white", "turkish-coffee", "affogato", "latte-macchiato", "greek-frappe", "irish-coffee", "cafe-au-lait", "pumpkin-spice-latte", "moroccan-mint-tea", "turkish-tea", "oolong-tea"] }} />
      <Composition id="ThumbE100CoffeeTeaFullBleed" component={GsThumbFullBleedV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "coffeetea-e100-thumb", number: "70", grid: ["espresso", "cappuccino", "caffe-latte", "americano", "iced-coffee", "caffe-mocha", "frappuccino", "espresso-macchiato", "cold-brew-coffee", "black-tea", "green-tea", "bubble-tea", "matcha-latte", "cortado", "flat-white", "turkish-coffee", "affogato", "irish-coffee", "cafe-au-lait", "pumpkin-spice-latte", "moroccan-mint-tea", "doppio", "masala-chai", "yerba-mate"] }} />
      <Composition id="ThumbE100CoffeeTeaCoin" component={GsThumbCoinV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "coffeetea-e100-thumb", topicPlural: "COFFEE & TEA DRINKS", number: "70", grid: ["espresso", "cappuccino", "caffe-latte", "americano", "iced-coffee", "caffe-mocha", "frappuccino", "espresso-macchiato", "black-tea", "green-tea", "bubble-tea", "matcha-latte"] }} />
      <Composition id="ThumbE100CoffeeTeaStrip" component={GsThumbStripV5} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "coffeetea-e100-thumb", topicPlural: "COFFEE & TEA DRINKS", number: "70", grid: ["espresso", "cappuccino", "caffe-latte", "americano", "iced-coffee", "caffe-mocha", "frappuccino", "black-tea", "green-tea", "bubble-tea"] }} />
      ...
      {[
        ...
        { ep: "E100", items: COFFEE_TEA_E100, mode: "coffeetea-e100", title: "Guess the Coffee or Tea Drink", v2: true },
      ].flatMap((e) =>
        [0, 1, 2, 3, 4].map((part) => (
