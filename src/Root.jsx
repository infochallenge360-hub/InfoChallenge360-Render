...
export const RemotionRoot = () => {
  return (
    <>
      ...
      <Composition id="ThumbE74VegSplit" component={GsThumbSplitV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "veg-e74-thumb", easySlug: "potato", hardSlug: "scorzonera", word: "VEGETABLE?", number: "70", badge: "Only 1% get 100%" }} />
