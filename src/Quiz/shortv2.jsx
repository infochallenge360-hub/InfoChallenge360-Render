...
const Clue = ({ item, mode, revealed, accent }) => {
  ...
  if (mode === "forts-e63") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`forts/${item.slug}.jpg`)} style={{ width: 580, height: 640, objectFit: "cover", borderRadius: 28 }} /></div>;
