...
const Clue = ({ item, mode, revealed, accent }) => {
  ...
  if (mode === "historicalfigure-e93") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`historicalfigures93/${item.slug}.jpg`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "bodypart-e94") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`bodyparts94/${item.slug}.png`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "sportequipment-e95") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`sportequipment95/${item.slug}.png`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "empire-e96") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`empiremaps96/${item.slug}.png`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "horsebreed-e97") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`horsebreeds97/${item.slug}.jpg`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "cheese-e98") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`cheese98/${item.slug}.jpg`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "pasta-e99") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`pasta99/${item.slug}.jpg`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
  if (mode === "coffeetea-e100") return <div style={{ ...card, width: 640, height: 700 }}><Img src={staticFile(`coffeetea100/${item.slug}.jpg`)} style={{ width: 500, height: 600, objectFit: "contain" }} /></div>;
