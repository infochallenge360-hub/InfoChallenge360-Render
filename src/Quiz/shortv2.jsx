...
const voFile = (item, mode) => mode === "capitals-e63" ? `sfx/wc-${item.iso}.wav` : VO_PREFIX[mode] ? `sfx/${VO_PREFIX[mode]}-${item.slug}.wav` : mode === "capitals" ? `sfx/cp-${item.iso}.wav` : `sfx/fl-${item.iso}.wav`;
