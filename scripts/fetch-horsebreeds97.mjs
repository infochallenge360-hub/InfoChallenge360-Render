// Fetches real free photos for the Guess the Horse Breed episode from
...
import { HORSE_BREEDS_E97 } from "../src/Quiz/horseBreedsE97Data.js";

const DEST = "public/horsebreeds97";
...
let ok = 0, fail = [];
for (const item of HORSE_BREEDS_E97) {
...
console.log(`\n${ok}/${only ? only.length : HORSE_BREEDS_E97.length} fetched.`);
