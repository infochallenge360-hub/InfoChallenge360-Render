// Fetches real free photos for the Guess the Coffee/Tea Drink episode from
...
import { COFFEE_TEA_E100 } from "../src/Quiz/coffeeTeaE100Data.js";

const DEST = "public/coffeetea100";
...
let ok = 0, fail = [];
for (const item of COFFEE_TEA_E100) {
...
console.log(`\n${ok}/${only ? only.length : COFFEE_TEA_E100.length} fetched.`);
