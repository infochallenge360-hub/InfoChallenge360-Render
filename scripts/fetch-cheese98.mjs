// Fetches real free photos for the Guess the Cheese episode from
...
import { CHEESE_E98 } from "../src/Quiz/cheeseE98Data.js";

const DEST = "public/cheese98";
...
console.log(`\n${ok}/${only ? only.length : CHEESE_E98.length} fetched.`);
