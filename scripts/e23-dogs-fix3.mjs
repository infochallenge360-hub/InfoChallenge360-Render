...
const QUERIES = {
  "whippet": "Whippet dog show standing filetype:jpg",
  "vizsla": "Hungarian Vizsla dog field",
  "belgian-malinois": "Malinois dog field",
  "xoloitzcuintli": "Xolo hairless dog Mexico",
  "azawakh": "Azawakh sighthound",
};
